...
public class ReportGenerator {
	...
	public static void saveReport(ReleaseHistory rh, String fname) throws IOException {
		...
		fw.write("<!doctype html> <html> <head> "
				...
				+ "Software Engineering class of the CS department of the University of Ioannina, Winter Semester 2014/2015. "
				...
				+ "<li><a href='http://www.twitter.com/kabamarules'>Follow Me on Twitter</a></li> "
				+ "<li><a href='http://cv.fotiad.is/'>My Website</a></li> </ul><br>"
				...
				+ "<p>Template adapted from <a href='https://github.com/bricemason/am-i-sencha-touch-ready'>"
				+ "bricemason's work</a></p>"
				+ "</div> </body> </html>");
